 ...
 */
function obterOpcaoDoMenu(): number {
 ...
 */
function obterEscolhaDePizza(): number {
 ...
 */
function mensagemFinalizarPedidoESair(): void {
 ...
 */
function exibirMensagemErroOpcaoInvalida(): void {
 ...
 */
function exibirMensagemErroPizzaInvalida(): void {
 ...
 */
function exibirPizzaAdicionadaComSucesso(nomePizza: string): void {
 ...
 */
function processarAdicionarPizza(): void {
